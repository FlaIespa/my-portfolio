      ...
      <div className='flex justify-center'>
        ...
        <form className='flex flex-col gap-4 tm:w-full sm:w-full lg:w-[88%] ' ref={form} onSubmit={sendEmail}>
          ...
          <div className='flex justify-start mt-5 mb-8'>
            <button type='submit'
              className='px-[1.6em] py-[.8em] bg-[#3b7a57] coursor-pointer rounded-[4px] flex justify-start items-center gap-1 border-[#3b7a57] border-2 lg:text-[.8rem] sm:text-[.8rem]'>Send</button>
          </div>
        </form>
      </div>
